...
class textblock extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement('textarea', 'label', get_string('textblock', 'ivplugin_inlineannotation'), ['size' => 100]);
        ...
        $mform->addElement('select', 'alignment', get_string('textalignment', 'ivplugin_inlineannotation'), [
            'left' => get_string('left', 'ivplugin_inlineannotation'),
            'center' => get_string('center', 'ivplugin_inlineannotation'),
            'right' => get_string('right', 'ivplugin_inlineannotation'),
        ]);
        ...
        // Add default font.
        array_unshift($availablefonts, [get_string('defaultfont', 'ivplugin_inlineannotation'), '']);
        $availablefonts = array_column($availablefonts, 0, 1);
        $mform->addElement('select', 'textfont', get_string('textfont', 'ivplugin_inlineannotation'), $availablefonts);
        ...
        $mform->addElement('text', 'bordercolor', get_string('bordercolor', 'ivplugin_inlineannotation') .
            '<span class="color-picker ml-2" style="background-color: ' .
