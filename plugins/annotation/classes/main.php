...
class main extends \ivplugin_richtext\main {
    ...
    public function get_property() {
        return [
            'name' => 'annotation',
            'title' => get_string('pluginname', 'ivplugin_annotation'),
            'icon' => 'bi bi-pip',
            'amdmodule' => 'ivplugin_annotation/main',
            'class' => 'ivplugin_annotation\\main',
            'form' => 'ivplugin_annotation\\form',
            'hascompletion' => false,
            'hastimestamp' => false,
            'hasreport' => false,
            'allowmultiple' => false,
            'description' => get_string('plugindescription', 'ivplugin_annotation'),
        ];
    }
