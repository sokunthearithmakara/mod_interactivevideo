...
class hotspot extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement('editor', 'content', get_string('content', 'ivplugin_annotation'), null, [
            'maxfiles' => -1,
            'maxbytes' => 0,
            'trusttext' => true,
            'noclean' => true,
        ...
        $mform->addElement(
            ...
            'usemodal',
            '',
            get_string('usemodal', 'ivplugin_annotation'),
            null,
            [0, 1],
        );
        ...
        $mform->addElement(
            ...
            'openbydefault',
            '',
            get_string('openbydefault', 'ivplugin_annotation'),
            null,
            [0, 1],
        );
        ...
        $mform->addElement(
            'text',
            'color',
            get_string('color', 'ivplugin_annotation') .
        ...
        $mform->addElement('text', 'opacity', get_string('opacity', 'ivplugin_annotation'), ['size' => 100]);
